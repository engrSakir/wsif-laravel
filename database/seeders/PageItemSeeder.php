...
class PageItemSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $page_item->image           = 'images/home/one-image.png';
        ...
        $page_item->image           = 'images/home/two-image.png';
        $page_item->show_on_home           = true;
        $page_item->save();
        ...
        $page_item->image           = 'images/home/three-image.png';
        $page_item->show_on_home           = true;
        $page_item->save();
        ...
        $page_item->image           = 'images/home/four-image.png';
        $page_item->show_on_home           = true;
        $page_item->save();
        ...
        $page_item->image           = 'images/home/five-image.png';
        $page_item->show_on_home           = true;
        $page_item->save();
    }
}
