            ...
            <div class="row justify-content-center">
                    ...
                    <div class="card team border-0 rounded shadow overflow-hidden">
                        ...
                        <div class="card-body content text-center">
                            ...
                            <small class="text-muted speciality">
                                Chairman, World Social Innovation Forum
                                <br>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 mt-4 pt-2 d-flex align-items-stretch">
                    <div class="card team border-0 rounded shadow overflow-hidden">
                        ...
                        <div class="card-body content text-center">
                            ...
                            <small class="text-muted speciality">
                                Board Member, World Social Innovation Forum <br>
                                Founding Partner, IxSA <br>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 mt-4 pt-2 d-flex align-items-stretch">
                    <div class="card team border-0 rounded shadow overflow-hidden">
                        ...
                        <div class="card-body content text-center">
                            ...
                            <small class="text-muted speciality">
                                Board Member, World Social Innovation Forum <br>
                                Chairman, Action Community for Entrepreneurship <br>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 mt-4 pt-2 d-flex align-items-stretch">
                    <div class="card team border-0 rounded shadow overflow-hidden">
                        ...
                        <div class="card-body content text-center">
                            <a href="#l" class="title text-dark h5 d-block mb-0">
                                Kurt Davis 🇺🇸
                            </a>
                            <small class="text-muted speciality">
                                Board Member, World Social Innovation Forum <br>
